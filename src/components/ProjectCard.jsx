...
export default function ProjectCard({ project, onViewDetails, animDelay = 0 }) {
  ...
  return (
    <article
      ...
      "
    >
      {/* ── Image (cover — first project photo) ────────────────────── */}
      <div className="relative h-52 overflow-hidden shrink-0">
        <img
          ...
          loading="lazy"
          className="
            w-full h-full object-cover img-enhance
        ...
        {project.images.length > 1 && (
          <span className="
            ...
            font-title text-[10px] font-bold tracking-wide-label tabular-nums
          ">
            <PhotoIcon />
